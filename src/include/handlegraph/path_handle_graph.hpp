...
public:
    ...
    // This part is for the oriented step handle API, for tracking the
    // orientation you are at along a path.
    //
    // You need to have at least these four methods to specify how information
    // is packed into an oriented_step_handle_t; by default we use
    // setp_bool_packing.
    ...
    /// Get the step handle of an oriented step.
    virtual step_handle_t get_step_handle_of_oriented_step(const oriented_step_handle_t& oriented_step_handle) const;
    ...
    // Then these other methods use those to provide the full oriented step
    // handle API. If you have a more efficient way to do it you can override
    // them.
